function openTicketDetailPage() {
  window.location = "./ticketDetails.html";
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function setActiveTicketDetails() {
    ...
    const price = activeTicketDetails.price || activeTicketDetails.prise || 0;
    if (totaTicketPrise) totaTicketPrise.innerText = activeTicketDetails.numberOfTickets * price;
    if (ticketPrise) ticketPrise.innerText = activeTicketDetails.numberOfTickets * price;
    if (ticketPriseDetail) ticketPriseDetail.innerText = price;
    if (totalUpiPayment) totalUpiPayment.innerText = activeTicketDetails.numberOfTickets * price;
    if (totalpricePayment) totalpricePayment.innerText = activeTicketDetails.numberOfTickets * price;
  }
